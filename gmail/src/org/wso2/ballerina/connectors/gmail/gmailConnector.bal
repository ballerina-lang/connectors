...
connector ClientConnector (string userId, string accessToken, string refreshToken, string clientId,
        ...
        if (statusCode == 200) {
            if (jsonResponse["message"].payload != null) {
                if (jsonResponse["message"].payload.headers != null) {
                    int lengthOfHeader = lengthof jsonResponse["message"].payload.headers;
                    int j = 0;
                ...
                if (jsonResponse["message"].payload.parts != null) {
                    int lengthOfParts = lengthof jsonResponse["message"].payload.parts;
                    int k = 0;
                    while (k < lengthOfParts) {
                        ...
                        parts.body = body;
                        int lengthOfPartHeader = lengthof jsonResponse["message"].payload.parts[k].headers;
                        int l = 0;
            ...
            if (jsonResponse["message"].labelIds != null) {
                int lengthOfLabel = lengthof jsonResponse["message"].labelIds;
                int i = 0;
    ...
    action listDrafts (ClientConnector g, DraftsListFilter listDrafts) (Drafts, Error) {
        ...
        if (statusCode == 200) {
            ...
            if (jsonResponse.drafts != null) {
                int lengthOfDrafts = lengthof jsonResponse.drafts;
                int a = 0;
                while (a < lengthOfDrafts) {
                    ...
                    if (jsonResponse.drafts[a]["message"].payload != null) {
                        if (jsonResponse.drafts[a]["message"].payload.headers != null) {
                            int lengthOfHeader = lengthof jsonResponse.drafts[a]["message"].payload.headers;
                            int j = 0;
                            while (j < lengthOfHeader) {
                                Header header = {};
                        ...
                        if (jsonResponse.drafts[a]["message"].payload.parts != null) {
                            int lengthOfParts = lengthof jsonResponse.drafts[a]["message"].payload.parts;
                            int k = 0;
                            while (k < lengthOfParts) {
                                Parts parts = {};
                                Body body = {};
                                ...
                                parts.body = body;
                                int lengthOfPartHeader = lengthof jsonResponse.drafts[a]["message"].payload.parts[k].
                                headers;
                                int l = 0;
                                while (l < lengthOfPartHeader) {
                                    Header header_2 = {};
                    ...
                    if (jsonResponse.drafts[a]["message"].labelIds != null) {
                        int lengthOfLabel = lengthof jsonResponse.drafts[a]["message"].labelIds;
                        int i = 0;
                        while (i < lengthOfLabel) {
    ...
    action listHistory (ClientConnector g, string startHistoryId, HistoryFilter listHistory) (HistoryList,
        ...
        if (statusCode == 200) {
            ...
            if (jsonResponse.history != null) {
                int i = 0;
                int length = lengthof jsonResponse.history;
                while (i < length) {
                    History history = {};
                    history.messages = [];
                    ...
                    if (jsonResponse.history[i].messages != null) {
                        int lengthOfMessages = lengthof jsonResponse.history[i].messages;
                        int a = 0;
                        while (a < lengthOfMessages) {
                            ...
                            if (jsonResponse.history[i].messages[a].payload != null) {
                                if (jsonResponse.history[i].messages[a].payload.headers != null) {
                                    int lengthOfHeader = lengthof jsonResponse.history[i].messages[a].payload.headers;
                                    int j = 0;
                                    while (j < lengthOfHeader) {
                                        Header header = {};
                                ...
                                if (jsonResponse.history[i].messages[a].payload.parts != null) {
                                    int lengthOfParts = lengthof jsonResponse.history[i].messages[a].payload.parts;
                                    int k = 0;
                                    while (k < lengthOfParts) {
                                        Parts parts = {};
                                        Body body = {};
                                        ...
                                        parts.body = body;
                                        int lengthOfPartHeader = lengthof jsonResponse.history[i].messages[a].payload.
                                        parts[k].headers;
                                        int l = 0;
                                        while (l < lengthOfPartHeader) {
                                            Header header_2 = {};
                            ...
                            if (jsonResponse.history[i].messages[a].labelIds != null) {
                                int lengthOfLabel = lengthof jsonResponse.history[i].messages[a].labelIds;
                                int l = 0;
                    ...
                    if (jsonResponse.history[i].messagesAdded != null) {
                        int lengthOfMessagesAdded = lengthof jsonResponse.history[i].messagesAdded;
                        int k = 0;
                        while (k < lengthOfMessagesAdded) {
                            int l = 0;
                            int lengthOfLabels = lengthof jsonResponse.history[i].messagesAdded[k]["message"].labelIds;
                            Messages messagesAdded = {};
                            Email email = {};
                            email.labelIds = [];
                    ...
                    if (jsonResponse.history[i].messagesDeleted != null) {
                        int m = 0;
                        int lengthOfMessagesDeleted = lengthof jsonResponse.history[i].messagesDeleted;
                        while (m < lengthOfMessagesDeleted) {
                            int l = 0;
                            int lengthOfLabels = lengthof jsonResponse.history[i].messagesDeleted[m]["message"].labelIds;
                            Messages messagesDeleted = {};
                            Email email = {};
                            email.labelIds = [];
                    ...
                    if (jsonResponse.history[i].labelsAdded != null) {
                        int p = 0;
                        int lengthOfLabelsAdded = lengthof jsonResponse.history[i].labelsAdded;
                        while (p < lengthOfLabelsAdded) {
                            int l = 0;
                            int lengthOfLabels = lengthof jsonResponse.history[i].labelsAdded[p]["message"].labelIds;
                            Messages labelsAdded = {};
                            Email email = {};
                            email.labelIds = [];
                    ...
                    if (jsonResponse.history[i].labelsRemoved != null) {
                        int q = 0;
                        int lengthOfLabelsRemoved = lengthof jsonResponse.history[i].labelsRemoved;
                        while (q < lengthOfLabelsRemoved) {
                            int l = 0;
                            int lengthOfLabels = lengthof jsonResponse.history[i].labelsAdded[q]["message"].labelIds;
                            Messages labelsRemoved = {};
                            Email email = {};
                            email.labelIds = [];
    ...
    action createLabel (ClientConnector g, string labelName, string messageListVisibility, string labelListVisibility,
        ...
        if (createLabel != null) {
            ...
            if (types != "") {
                createLabelRequest.labelType = types;
            }
        ...
        if (statusCode == 200) {
            ...
            if (jsonResponse["type"] != null) {
                response.labelType, _ = (string)jsonResponse["type"];
            }
            if (jsonResponse.messagesTotal != null) {
                response.messagesTotal, _ = (int)jsonResponse.messagesTotal;
            }
    ...
    action listLabels (ClientConnector g) (Labels, Error) {
        ...
        if (statusCode == 200) {
            int length = lengthof jsonResponse.labels;
            int i = 0;
            while (i < length) {
                Label label = {};
                ...
                if (jsonResponse.labels[i]["type"] != null) {
                    label.labelType, _ = (string)jsonResponse.labels[i]["type"];
                }
    ...
    action readThread (ClientConnector g, string threadId, ThreadFilter readThread) (Thread, Error) {
        ...
        if (statusCode == 200) {
            ...
            if (jsonResponse.messages != null) {
                int lengthOfMessages = lengthof jsonResponse.messages;
                int a = 0;
                while (a < lengthOfMessages) {
                    EmailMessage mailMessage = {};
                    mailMessage.labelIds = [];
                    if (jsonResponse.messages[a].payload != null) {
                        if (jsonResponse.messages[a].payload.headers != null) {
                            int lengthOfHeader = lengthof jsonResponse.messages[a].payload.headers;
                            int j = 0;
                            while (j < lengthOfHeader) {
                                Header header = {};
                        ...
                        if (jsonResponse.messages[a].payload.parts != null) {
                            int lengthOfParts = lengthof jsonResponse.messages[a].payload.parts;
                            int k = 0;
                            while (k < lengthOfParts) {
                                Parts parts = {};
                                Body body = {};
                                ...
                                parts.body = body;
                                int lengthOfPartHeader = lengthof jsonResponse.messages[a].payload.parts[k].headers;
                    ...
                    if (jsonResponse.messages[a].labelIds != null) {
                        int lengthOfLabel = lengthof jsonResponse.messages[a].labelIds;
                        int i = 0;
                        while (i < lengthOfLabel) {
    ...
    action listThreads (ClientConnector g, ThreadListFilter listThreads) (Threads, Error) {
        ...
        if (statusCode == 200) {
            ...
            if (jsonResponse.threads != null) {
                int lengthOfThreads = lengthof jsonResponse.threads;
                int a = 0;
                int m = 0;
                while (a < lengthOfThreads) {
                    ...
                    if (jsonResponse.threads[a].messages != null) {
                        int lengthOfMessages = lengthof jsonResponse.threads[a].messages;
                        while (m < lengthOfMessages) {
                            if (jsonResponse.threads[a].messages[m].payload != null) {
                                if (jsonResponse.threads[a].messages[m].payload.headers != null) {
                                    int lengthOfHeader = lengthof jsonResponse.threads[a].messages[m].payload.headers;
                                    int j = 0;
                                    while (j < lengthOfHeader) {
                                        Header header = {};
                                ...
                                if (jsonResponse.threads[a].messages[m].payload.parts != null) {
                                    int lengthOfParts = lengthof jsonResponse.threads[a].messages[m].payload.parts;
                                    int k = 0;
                                    while (k < lengthOfParts) {
                                        Parts parts = {};
                                        Body body = {};
                                        ...
                                        parts.body = body;
                                        int lengthOfPartHeader = lengthof jsonResponse.threads[a].messages[m].payload.
                                        parts[k].headers;
                                        ...
                                        while (l < lengthOfPartHeader) {
                                            ...
                                            if (jsonResponse.threads[a].
                                                ...
                                                header_2.value, _ =
                                                (string)jsonResponse.threads[a].messages[m].payload.parts[k].headers[l]
                                                                                                             .value;
                                            }
                                            parts.headers[k] = header_2;
                                            l = l + 1;
                                ...
                                if (jsonResponse.threads[a].messages[m].payload.body.attachmentId != null) {
                                    body_2.attachmentId, _ = (string)jsonResponse.threads[a].messages[m].
                                                                                             payload.body.attachmentId;
                                }
                                messagePayload.body = body_2;
                                if (jsonResponse.threads[a].messages[m].payload.filename != null) {
                                    messagePayload.filename, _ = (string)jsonResponse.threads[a].messages[m].payload.
                                                                                                             filename;
                                }
                                if (jsonResponse.threads[a].messages[m].payload.mimeType != null) {
                                    messagePayload.mimeType, _ = (string)jsonResponse.threads[a].messages[m].payload.
                                                                                                             mimeType;
                                }
                                if (jsonResponse.threads[a].messages[m].payload.partId != null) {
                                    messagePayload.partId, _ = (string)jsonResponse.threads[a].messages[m].payload.
                                                                                                           partId;
                                }
                                mailMessage.payload = messagePayload;
                            }
                            ...
                            if (jsonResponse.threads[a].messages[m].labelIds != null) {
                                int lengthOfLabel = lengthof jsonResponse.threads[a].messages[m].labelIds;
                                int i = 0;
                                while (i < lengthOfLabel) {
                        ...
                        if (jsonResponse.messages[a].payload.parts != null) {
                            ...
                            while (k < lengthOfParts) {
                                ...
                                while (l < lengthOfPartHeader) {
                                    Header header_2 = {};
                                    if (jsonResponse.messages[a].payload.parts[k].headers[l].name != null) {
                                        header_2.name, _ = (string)jsonResponse.messages[a].payload.parts[k].headers[l].
                                                                                                             name;
                                    }
                                    if (jsonResponse.messages[a].payload.parts[k].headers[l].value != null) {
                                        header_2.value, _ = (string)jsonResponse.messages[a].payload.parts[k].headers[l]
                                                                                                              .value;
                                    }
                                    parts.headers[k] = header_2;
                                    l = l + 1;
    ...
    action readMail (ClientConnector g, string messageId, ThreadFilter readMail) (EmailMessage, Error) {
        ...
        if (statusCode == 200) {
            if (jsonResponse.payload.headers != null) {
                int lengthOfHeader = lengthof jsonResponse.payload.headers;
                int j = 0;
                while (j < lengthOfHeader) {
                    Header header = {};
            ...
            if (jsonResponse.payload.parts != null) {
                int lengthOfParts = lengthof jsonResponse.payload.parts;
                int k = 0;
                while (k < lengthOfParts) {
                    Parts parts = {};
                    Body body = {};
                    ...
                    parts.body = body;
                    int lengthOfPartHeader = lengthof jsonResponse.payload.parts[k].headers;
            ...
            int lengthOfLabel = lengthof jsonResponse.labelIds;
            int i = 0;
            while (i < lengthOfLabel) {
